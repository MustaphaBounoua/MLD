...
CHECKPOINT_DIR = os.path.join(CHECKPOINT_DIR, 'mmld_octavia_64_32_noaug')
...
PATHS = {
  ...
  "image":   "/home/bounoua/work/mld/trained_models/CUB/AEs/ae_image_64/version_0/checkpoints/epoch=2999-step=414000.ckpt",
...
PATHS = {
  ...
  "image":   "/home/renault/Documents/code/mld/trained_models/CUB/AE_mmvaeplus/ae_model_plus_64_image0/version_0/checkpoints/epoch=999-step=69000.ckpt",
    "sentence":"/home/bounoua/work/mld/trained_models/CUB/ae_text_32/ae_32_non_sentence0/version_0/checkpoints/epoch=1009-step=1396830.ckpt",
...
if __name__ == "__main__":
    ...
    modalities_list = [    # Bird_Image(latent_dim=dim_image,reconstruction_weight = r_w_image, lhood_name="laplace" ,deterministic=True,resnet = "resnet"),
                       Bird_Image(latent_dim=dim_image, deterministic = True,distengeled=False, lhood_name="laplace",resnet="resnet" ),
                        Sentence(latent_dim=dim_sentence, deterministic =True ,distengeled=False,  lhood_name="categorical",resnet= True )
