...
parser.add_argument('--model', type=str, default="mmld_uni")
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        tb_logger = TensorBoardLogger(save_dir=CHECKPOINT_DIR,
                                      name=str(args.seed))
        # model.stat = get_stat("/home/bounoua/work/mld/trained_models/MNISTSVHN/mmld_uni/3/version_0/stat.pickle")
        print(model)
        trainer = pl.Trainer(
            logger=tb_logger,
            ...
            # resume_from_checkpoint= "/home/bounoua/work/mld/trained_models/MNISTSVHN/mmld_uni/3/version_0/checkpoints/epoch=9-step=87600.ckpt"
        )
