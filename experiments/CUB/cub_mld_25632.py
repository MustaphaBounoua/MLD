...
if __name__ == "__main__":
    ...
    modalities_list = [     Bird_Image(latent_dim=dim_image,reconstruction_weight = r_w_image, lhood_name="laplace" ,deterministic=True,resnet = "autokl"),
    ...
    CHECKPOINT_DIR = os.path.join(CHECKPOINT_DIR, 'MLDautokl_latent_64res'+str(args.d))
    #  print(model)
